...
<head>
    <base href="../../">
    <title>System Error - Sajek Tourism</title>
    <meta charset="utf-8" />
        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div class="d-flex flex-column flex-column-fluid text-center p-10 py-lg-15">
                ...
                <a href="/login" class="mb-10 pt-lg-10">
                    <img alt="Logo" src="{{ asset('assets/backend/media/logos/logo-1.svg') }}"
                        class="h-40px mb-5" />
                </a>
                <!--end::Logo-->
                <!--begin::Wrapper-->
                <div class="pt-lg-10 mb-10">
                    ...
                    <div class="text-center">
                        <a href="/dashboard" class="btn btn-lg btn-primary fw-bolder">Go to
                            homepage</a>
                    </div>
                    <!--end::Action-->
                </div>
                ...
                <div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-350px"
                    style="background-image: url(assets/backend/media/illustrations/sketchy-1/17.png"></div>
                <!--end::Illustration-->
            </div>
            <!--end::Content-->
            <!--begin::Footer-->
