                                ...
                                <div class="image-post-slider">
                                    <ul class="bxslider">
                                        <li>
                                            <div class="news-post image-post2">
                                                <div class="post-gallery">
                                                    <img src="assets/frontend/upload/news-posts/slide1a.jpg"
                                                        alt="">
                                                    <div class="hover-box">
                                                        <div class="inner-hover">
                                                            <a class="category-post world"
                                                                href="world.html">business</a>
                                        ...
                                        <li>
                                            <div class="news-post image-post2">
                                                <div class="post-gallery">
                                                    <img src="assets/frontend/upload/news-posts/slide2a.jpg"
                                                        alt="">
                                                    <div class="hover-box">
                                                        <div class="inner-hover">
                                                            <a class="category-post travel"
                                        ...
                                        <li>
                                            <div class="news-post image-post2">
                                                <div class="post-gallery">
                                                    <img src="assets/frontend/upload/news-posts/slide3a.jpg"
                                                        alt="">
                                                    <div class="hover-box">
                                                        <div class="inner-hover">
                                                            <a class="category-post fashion"
                                ...
                                <div class="image-post-slider">
                                    <ul class="bxslider">
                                        <li>
                                            <div class="news-post image-post2">
                                                <div class="post-gallery">
                                                    <img src="assets/frontend/upload/news-posts/im3.jpg"
                                                        alt="">
                                                    <div class="hover-box">
                                                        <div class="inner-hover">
                                                            <h2><a href="single-post.html">Pellentesque odio nisi,
                                        ...
                                        <li>
                                            <div class="news-post image-post2">
                                                <div class="post-gallery">
                                                    <img src="assets/frontend/upload/news-posts/im1.jpg"
                                                        alt="">
                                                    <div class="hover-box">
                                                        <div class="inner-hover">
                                                            <h2><a href="single-post.html">Pellentesque odio nisi,
                                        ...
                                        <li>
                                            <div class="news-post image-post2">
                                                <div class="post-gallery">
                                                    <img src="assets/frontend/upload/news-posts/im2.jpg"
                                                        alt="">
                                                    <div class="hover-box">
                                                        <div class="inner-hover">
                                                            <h2><a href="single-post.html">Pellentesque odio nisi,
                            ...
                            <div class="widget tab-posts-widget">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="option1">
                                        <ul class="list-posts">
                                            <li>
                                                <img src="assets/frontend/upload/news-posts/listw1.jpg"
                                                    alt="">
                                                <div class="post-content">
                                                    <h2><a href="single-post.html">Pellentesque odio nisi, euismod in,
                                                            pharetra a, ultricies in, diam. </a></h2>
                                            ...
                                            <li>
                                                <img src="assets/frontend/upload/news-posts/listw2.jpg"
                                                    alt="">
                                                <div class="post-content">
                                                    <h2><a href="single-post.html">Sed arcu. Cras consequat. </a></h2>
                                                    <ul class="post-tags">
                                            ...
                                            <li>
                                                <img src="assets/frontend/upload/news-posts/listw3.jpg"
                                                    alt="">
                                                <div class="post-content">
                                            ...
                                            <li>
                                                <img src="assets/frontend/upload/news-posts/listw4.jpg"
                                                    alt="">
                                                <div class="post-content">
                                            ...
                                            <li>
                                                <img src="assets/frontend/upload/news-posts/listw5.jpg"
                                                    alt="">
                                                <div class="post-content">
