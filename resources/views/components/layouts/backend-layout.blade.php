...
<head>
    ...
    <meta property="og:url" content="http://sajektourism.com/" />
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    <!--begin::Logo-->
                    <a href="/dashboard">
                        <img alt="Logo" src="{{ asset('assets/backend/media/logos/logo-1-dark.svg') }}"
                            class="h-25px logo" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Aside toggler-->
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3" href="#"
                                                                title="Coming soon" data-bs-toggle="tooltip"
                            ...
                            <div class="d-flex align-items-center gap-2 gap-lg-3">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                        data-kt-menu="true" id="kt_menu_61cf08e768515">
                                        <!--begin::Header-->
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <div>
                                                    <select class="form-select form-select-solid"
                                                        ...
                                                        data-dropdown-parent="#kt_menu_61cf08e768515"
                ...
                <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="https://sajektourism.com/" target="_blank"
                        ...
                        <ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
                            <li class="menu-item">
                                <a href="https://sajektourism.com/" target="_blank" class="menu-link px-2">About</a>
                            </li>
                            <li class="menu-item">
                                <a href="https://sajektourism.com/" target="_blank"
