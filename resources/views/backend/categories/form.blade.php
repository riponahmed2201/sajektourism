<x-layouts.backend-layout>
    ...
    <!--begin::Toolbar  -->
    <x-backend.toolbar title="Add category" :breadcrumbs="[['label' => 'Home', 'url' => '/dashboard'], ['label' => 'Add category']]" buttonIcon="bi bi-list" buttonText="Category List"
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-12 fv-row mb-5">
                                        ...
                                        <textarea class="form-control form-control-solid" placeholder="Enter details" name="details" required
                                            data-kt-autosize="true">{{ $category->details ?? old('details') }}</textarea>
                                        @error('details')
                                            <span class="text-danger mt-2">{{ $message }}</span>
                                        @enderror
                                    </div>
